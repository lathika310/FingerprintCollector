...
struct FingerprintRecord: Identifiable {
    ...
    struct FingerprintRecord: Identifiable {
        ...
        let minor: Int
        let rssi: Int
        let mode: String   // "live" or "median15s"
    }
    ...
    struct ContentView: View {
        ...
        var body: some View {
            VStack(spacing: 12) {
                ...
                // 15s median capture (your existing logic)
                HStack {
        ...
        // One row per beacon using last completed 15s window median RSSI
